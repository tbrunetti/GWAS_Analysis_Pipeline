...
cols=c("blue", "green", "orange", "yellow", "black","red")
...
legend("topright", levels(pcs_with_pops$population),pch=c(21,21,21,21,21,21),pt.bg=cols,pt.cex=1,cex=.5)
legend("bottomleft", levels(pcs_with_pops$group),pch=c(17,20),pt.cex=0.5,cex=0.5)
